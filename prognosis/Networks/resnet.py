...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        self.first_covd_param = first_covd_param
        ...
        self.conv1 = nn.Conv2d(self.input_channel_num, self.inplanes, kernel_size=self.first_covd_param[0], stride=self.first_covd_param[1], padding=self.first_covd_param[2],
                               bias=False)
        ...
        self.classifier = nn.Sequential(nn.Linear(512 * block.expansion, self.feature_dim),
                                        nn.Dropout(0.25),
                                        nn.ReLU(),
                                        nn.Linear(32, 1))
